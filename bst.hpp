  ...
  template <typename Key, typename T>
    class bst {
      public:
        ...
        void insert(typename bst_node::data_type x)
        {
          insert(x, root);
        }
        ...
        void remove(Key key_name)
        {
          remove(key_name, root);
        }
        ...
        void remove(Key key_name, bst_node* node) {
          ...
          {
            if (!remove_leaf(key_name, node) &&
                !rm_one_child(key_name, node) &&
        ...
        bst_node* get_node(Key key_name)
        {
          return get_node(key_name, root);
        }
